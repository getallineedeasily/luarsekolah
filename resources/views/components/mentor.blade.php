<div class="max-w-10/12 mx-auto text-white">
    <div class="max-w-10/12 mb-9">
        <h2 class="text-[#FFD633] text-[36px] font-semibold pb-6">Kenali Mentor Kami!</h2>
        <h3 class="font-medium text-[24px]">Belajar dengan Mentor Profesional dari Berbagai
            Perusahaan Teknologi & Kreatif</h3>
        <span class="font-lexend text-[#E7E7E7]">Dari kampus ke dunia kerja, bangun portofolio bersama mentor ahli yang
            sudah
            berpengalaman
            di industri</span>
        <a href="#"
            class="font-medium text-sm w-[519px] rounded-md border border-white block p-2.5 text-center mt-8">Mulai
            dengan Mentor
            Sekarang</a>
    </div>
    <div class="text-center flex gap-2.5 justify-between">
        @foreach ($mentor as $m)
            <div class="w-[150px] h-[280px]">
                <div class="w-[150px] h-[150px] mb-2">
                    <img src="{{ $m->mentor_image }}" alt="{{ $m->mentor }}" class="w-full h-full object-cover">
                </div>
                <div class="space-y-2">
                    <p class="text-xl">{{ $m->mentor }}</p>
        ...
        <div class="w-[150px] h-[280px]">
            ...
            <div class="space-y-2">
                <p class="text-xl">Moh Aufal Marom Arrozi</p>
                <p class="font-medium text-xs">Senior Software Engineer</p>
                <p class="text-xs">di Perusahaan X</p>
            </div>
        </div>
        <div class="w-[150px] h-[280px] relative">
            <div style="background: radial-gradient(105.58% 50% at 50% 50%, rgba(211, 211, 211, 0.25) 0%, rgba(109, 109, 109, 0.25) 100%); backdrop-filter: blur(4px)"
                ...
                <span class="text-white font-lexend font-light">Lihat Lainnya</span>
            </div>
        </div>
    </div>
</div>
